...
- **Artist** notes link to the **scene** and **genre** hubs they belong to — those links are the graph edges.
- Color groups are pre-set: anchors gold, scenes blue, genres green, the reservoir grey, ordinary artists light.
