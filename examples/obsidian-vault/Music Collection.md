...
A taste map of the collection. Open the **graph view** (Ctrl/Cmd-G) to see artists cluster around the scene and genre hubs they link to; multi-scene artists bridge the clusters, and combo acts link straight to the members they share. Nothing is pre-weighted — the densest nodes are whatever the connectivity makes them.
